...
public class BDController {
    ...
    private final RepoTransporte repoTransporte;
    private final Repositorio<Trayecto> repoTrayecto;
    ...
    public String cargarBD(Request request, Response response) {
    ...
    public String borrarBD(Request request, Response response) {
        response.type("application/json");

        try{
            //borrar organizaciones sectores
            ...
            //borrar miembros
            this.repoMiembro.borrarTodos();

            List<Trayecto> trayectos = this.repoTrayecto.buscarTodos();
            for (Trayecto trayecto : trayectos) {
                this.repoTrayecto.borrar(trayecto);
            }

            //borrar actividades
            this.repoActividad.borrarTodas();

            //borrar agentes
            this.repoAgente.borrarTodos();

            //borrar transportes
            this.repoTransporte.borrarTodos();
        }
        catch (Exception e){
            EntityManagerHelper.rollback();
            return "Error al borrar datos: " + e.getMessage();
        }
